 ...
 */
UCLASS(abstract)
class TIANGUO_API AHorrorCharacter : public AtianguoCharacter
{
	GENERATED_BODY()
...
protected:
	...
	AActor* GetLookedAtInteractable();

	/** Blueprint event for interact logic */
	UFUNCTION(BlueprintImplementableEvent, Category="Interaction")
	void BP_OnInteract(AActor* HitActor);
